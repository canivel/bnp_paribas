...
# st = time.time()
# scores = cross_validation.cross_val_score(clf, X_train, y_train, scoring='log_loss', cv=2, verbose=2)
# print(scores.mean()*-1)
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:, 1]}).to_csv('data/extra_trees_1_4.csv', index=False)
