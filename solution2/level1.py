...
def train_data_from_level1(df, train_split):
    ...
    feat_pack = np.hstack((X[train_split:], pred1, pred2, pred3, pred4, pred5))
    return feat_pack, y[train_split:], standard_trans, clf1, clf2, clf3, clf4, clf5

def test_data_from_level1(path, standard_trans, clf1, clf2, clf3, clf4, clf5):
    '''
    ...
    # combine raw with meta
    feat_pack = np.hstack((X, pred1, pred2, pred3, pred4, pred5))
    return feat_pack